...
import '../services/technologies_and_skills_service/technologies_and_skills_service.dart';
import 'about_events.dart';
import 'about_state.dart';

class AboutBloc {
  final IAboutService _aboutService;
  final ITechnologiesAndSkillsService _technologiesAndSkillsService;
  ...
  AboutBloc(this._aboutService, this._technologiesAndSkillsService) {
  ...
  void _mapEventToState(AboutEvent event) async {
    ...
    if (event is LoadAboutEvent) {
      ...
      DevSkillsModel devSkills = await _technologiesAndSkillsService
          .getDevTechnologiesAndSkills(url: dev.blog);
